    ...
    <div className={`group relative inline-flex items-center justify-center ${className}`}>
      ...
      >
        ...
        <Image
          ...
          className={`relative rounded-[1.25rem] object-cover transition-transform duration-500 ease-out ${IMAGE_SCALE[size]} ${IMAGE_HOVER_SCALE[size]} group-hover:rotate-[-3deg]`}
        />
      </div>
    </div>
  );
