...
export function ExportButton({ data, headers, keys, filename }: ExportButtonProps) {
  ...
  return (
    <button
      ...
      disabled={exporting}
      className={`inline-flex items-center gap-1.5 rounded-lg border border-slate-200 px-3 py-1.5 text-xs font-medium text-slate-600 transition-colors hover:bg-slate-50 disabled:opacity-60 dark:border-slate-700/60 ${PREMIUM_DARK_BUTTON}`}
    >
