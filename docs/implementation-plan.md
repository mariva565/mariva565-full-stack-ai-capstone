...
- [ ] **Cloudflare R2 File Uploads:**
  - Качване на снимки/PDF към материалите.
...
| Фаза 2: Auth + Guards | ✅ MVP | Работи, но липсва: password reset, email verification, session management |
| Фаза 3: Core CRUD + Favorites | ✅ MVP | Основен flow работи; липсва: file upload, rich text editor, bulk operations |
| Фаза 4: Profile + Admin | ✅ MVP | Базов UI; липсва: avatar upload, admin dashboard stats, export |
