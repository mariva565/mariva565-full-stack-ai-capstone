...
>
> Потребителят работи с различни агенти поради квотни ограничения.
> Когато квотата на един агент свърши, работата продължава с друг агент — който не знае нищо за предишната сесия.
> `docs/dev-log.md` е **единствената приемственост** между агентите.
> Ако не го обновиш, следващият агент започва от нулата и губи context за свършената работа.
